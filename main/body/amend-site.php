...
?>
            ...
            <?php include 'top.php'; ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <h4 class="page-title">Tambah Tapak Pindaan</h4>
                            </li>
                        </ul>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <form action="?p=Input-Amend" method="post" class="form-horizontal" role="form">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card-box">
                                        <h3 class="form-section">Pengisian Info Pindaan Untuk Tapak <a href="?p=Info-Site&id=<?=$id?>"><u><?=$no_fail?></u></a></h3>
                                        <div class="row">
...
?>
        ...
        function mess()
        {
            alert("Tapak bina baru (PINDAAN) berjaya ditambah.");
            return true;
        }
        </script>
