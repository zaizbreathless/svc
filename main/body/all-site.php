                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <?php 
                                            ...
                                            echo "<h4 class=\"header-title m-t-0 m-b-30\">Senarai Semua Tapak</h4>
                                            ...
                                            $query->execute();
                                             ...
                                             if (!$query->rowCount() == 0) {
                                                ...
                                                echo "         <td>".$results['pemohonPSP']."</td>
                                                               ...
                                                               <td><a onclick=\"return confirm('Anda pasti untuk memadam rekod ini?')\" href=\"?p=Delete-Site&idd=".$results['id']."\" class=\"btn btn-danger btn-trans waves-effect w-md waves-warning m-b-5\">Padam</a></td>
