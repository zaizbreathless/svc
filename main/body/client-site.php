...
?>
            ...
            <?php include 'top.php'; ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <h4 class="page-title">Tapak Bina</h4>
                            </li>
                        </ul>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <?php 
                                            ...
                                            echo "<h4 class=\"header-title m-t-0 m-b-30\">Senarai Semua Tapak Pelanggan</h4>
                                            ...
                                            $query = $pdo->prepare("SELECT * FROM tapak WHERE client != '' LIMIT 0 , 100000000000" );
                                            ...
                                            $query->execute();
                                             ...
                                             if (!$query->rowCount() == 0) {
                                                ...
                                                echo "         <td>".$results['pemohonPSP']."</td>
                                                               ...
                                                               <td><strong>".$results['client']."</strong></td>
                                            ...
                                            $client = $fullname;
                                            $query = $pdo->prepare("SELECT * FROM tapak WHERE client LIKE '%$client%'" );
