...
?>
            ...
            <?php include 'top.php'; ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <h4 class="page-title">Tapak Utara 1</h4>
                            </li>
                        </ul>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30">Senarai Tapak Utara 1</h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $query = $pdo->prepare('SELECT * FROM tapak WHERE tarikhBorangCCC = 0 && kaw LIKE "%U1%" LIMIT 0 , 100000000000' );
