...
?>
            ...
            <?php include 'top.php'; ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <h4 class="page-title">Lawat Tapak</h4>
                            </li>
                        </ul>
                ...
                <div class="content">
                    <div class="container">
                            ...
                            <div class="col-lg-12">
                                <div class="card-box p-b-0">
                                    ...
                                    <div id="progressbarwizard" class="pull-in">
                                        <ul>
                                            <li><a href="#account-2" data-toggle="tab">Lawatan</a></li>
                                            <li><a href="#profile-tab-2" data-toggle="tab">Muat Naik Gambar</a></li>
                                            <li><a href="#finish-2" data-toggle="tab">Selesai</a></li>
                                        </ul>
                                        <form action="?p=Input-Visit" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="tab-content m-b-0">
                                            ...
                                            <div class="tab-pane p-t-10 fade" id="account-2">
                                                <div class="row">
                                                    <div class="form-group clearfix">
                                                        <label class="col-md-3 control-label " for="userName1">Laporan</label>
                                                        <div class="col-md-9">
                                                            <textarea id="laporan" name="laporan" class="form-control" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group clearfix">
                                                        <label class="col-md-3 control-label " for="password1"> Tindakan</label>
                                                        <div class="col-md-9">
                                                            <textarea id="tindakan" name="tindakan" class="form-control" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group clearfix">
                                                        <label class="col-md-3 control-label " for="confirm1">Tarikh Lawat</label>
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                <input type="date" id="tarikh" name="tarikh" class="form-control" placeholder="dd/mm/yyyy" id="datepicker-autoclose">
                                                                <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                            </div><!-- input-group -->
                                                        </div>
                                                    </div>
                                                    <div class="form-group clearfix">
                                                        <label class="col-md-3 control-label " for="confirm1">Masa Lawat</label>
                                                        <div class="col-md-4" >
                                                            <div class="input-group">
                                            ...
                                            <div class="tab-pane p-t-10 fade" id="profile-tab-2">
                                                <div class="row">
                                                    <button id="addfile" type="button" class="btn btn-warning waves-effect m-l-5" class="addfile">Tambah Gambar</button>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <button type="submit" class="btn btn-success waves-effect waves-light" onclick="return mess();">LAWAT</button></td>
                                                                </tr>
                                                            </table>
                                                            </div>
                                                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0 m-b-30">Info Lawatan Tapak Bina <a href="?p=Info-Site&id=<?=$id?>"><u><?=$no_fail?></u></a></h4>
                                    <?php if($lwt==0){ ?>
                                        <h4 align="center">Tiada Lawatan.</h4>
                                            <?php } else {?>
                                            <?php 
                                                $filterID = $id;
                                                $query = $connect->prepare("SELECT * FROM lawat WHERE tapak_id LIKE '%$filterID%' ORDER BY id DESC");
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <?php echo"<p class=\"form-control-static\"><font color=\"white\">".$results['laporan']."</font></p>";?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Tindakan</label>
                                                    <div class="col-sm-10">
                                                        <?php echo"<p class=\"form-control-static\"><font color=\"white\">".$results['tindakan']."</font></p>";?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <?php echo"<p class=\"form-control-static\"><font color=\"white\">".$results['tarikh']."&nbsp;&nbsp;&nbsp;".$results['masa']."</font></p>";?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Pegawai</label>
                                                    <div class="col-sm-10">
                                                        <?php echo"<p class=\"form-control-static\"><font color=\"white\">".$results['pegawai']."</font></p>";?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <div class="col-sm-10">
                                                        <?php echo "<a href=\"?p=Iso&id=".$results['id']."\" class=\"btn btn-purple w-md waves-effect waves-light m-b-5\"> <i class=\"fa fa-file m-r-5\"></i> <span>Cetak ISO</span> </a>";?>
                                                        <?php echo "<a href=\"?p=Gallery&id=".$results['id']."\" class=\"btn btn-pink w-md waves-effect waves-light m-b-5\"> <i class=\"fa fa-image m-r-5\"></i> <span>Galeri</span> </a>";?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
