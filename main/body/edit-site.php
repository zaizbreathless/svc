...
?>
            ...
            <?php include 'top.php'; ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <h4 class="page-title">Edit Tapak</h4>
                            </li>
                        </ul>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <form action="?p=Update-Site" method="post" class="form-horizontal" role="form">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card-box">
                                        <h3 class="form-section">Edit Info Tapak <?=$no_fail?></h3>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">No. Permohonan</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="noPermohonan" name="noPermohonan" value="<?=$noPermohonan?>" class="form-control" placeholder="Nombor Baru">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="tahun" type="text" id="tahun" class="form-control">
                                                            <option type="text" id="tahun" name="tahun" value="<?=$tahun?>"><?=$tahun?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="dariOSC" name="dariOSC" value="<?=$dariOSC?>" class="form-control" placeholder="dd/mm/yyyy">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="sediaKP" type="text" id="sediaKP" class="form-control">
                                                            <option type="text" id="sediaKP" name="sediaKP" value="<?=$sediaKP?>"><?=$sediaKP?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="kaw" type="text" id="kaw" class="form-control">
                                                            <option type="text" id="kaw" name="kaw" value="<?=$kaw?>"><?=$kaw?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" id="no_fail" name="no_fail" value="<?=$no_fail?>" class="form-control" placeholder="No BP">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">No Rujukan OSC</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="rujukanOSC" name="rujukanOSC" value="<?=$rujukanOSC?>" class="form-control" placeholder=" No OSC">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Kod Projek</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="kod" name="kod" value="<?=$kod?>" class="form-control" placeholder="Nama Kod">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" id="client" name="client" value="<?=$client?>" class="form-control" placeholder="Username Client">
                                                    </div>
                                                </div>
                                                <?php }?>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="jenisPermohonan" type="text" id="jenisPermohonan" class="form-control">
                                                            <option type="text" id="jenisPermohonan" name="jenisPermohonan" value="<?=$jenisPermohonan?>"><?=$jenisPermohonan?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="kategoriProjek" type="text" id="kategoriProjek" class="form-control">
                                                            <option type="text" id="kategoriProjek" name="kategoriProjek" value="<?=$kategoriProjek?>"><?=$kategoriProjek?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="jenisPemajuan" type="text" id="jenisPemajuan" class="form-control">
                                                            <option type="text" id="jenisPemajuan" name="jenisPemajuan" value="<?=$jenisPemajuan?>"><?=$jenisPemajuan?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="kategoriPermohonan" type="text" id="kategoriPermohonan" class="form-control">
                                                            <option type="text" id="kategoriPermohonan" name="kategoriPermohonan" value="<?=$kategoriPermohonan?>"><?=$kategoriPermohonan?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea id="perkara" name="perkara" value="<?=$perkara?>" class="form-control" rows="5"><?=$perkara?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Lokasi</label>
                                                    <div class="col-md-10">
                                                        <textarea id="lokasiTapak" name="lokasiTapak" value="<?=$lokasiTapak?>" class="form-control" rows="5"><?=$lokasiTapak?></textarea>
                                                    </div>
                                                </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card-box">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h3 class="form-section">Edit Info Pemohon</h3>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Pemohon PSP</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="pemohonPSP" name="pemohonPSP" value="<?=$pemohonPSP?>" class="form-control" placeholder="Nama">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Firma Pemohon</label>
                                                    <div class="col-md-10">
                                                        <textarea id="firmaPemohon" name="firmaPemohon" value="<?=$firmaPemohon?>" class="form-control" rows="5"><?=$firmaPemohon?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Alamat Pemohon</label>
                                                    <div class="col-md-10">
                                                        <textarea id="alamatPemohon" name="alamatPemohon" value="<?=$alamatPemohon?>" class="form-control" rows="5"><?=$alamatPemohon?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">No Telefon</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="telPemohon" name="telPemohon" value="<?=$telPemohon?>" class="form-control" placeholder="Telefon">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">No Fax</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="faxPemohon" name="faxPemohon" value="<?=$faxPemohon?>" class="form-control" placeholder="Fax">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <h3 class="form-section">Edit Info Pemaju</h3>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Pemilik/Pemaju</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="pemilikPemaju" name="pemilikPemaju" value="<?=$pemilikPemaju?>" class="form-control" placeholder="Nama">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Firma Pemaju</label>
                                                    <div class="col-md-10">
                                                        <textarea id="firmaPemaju" name="firmaPemaju" value="<?=$firmaPemaju?>" class="form-control" rows="5"><?=$firmaPemaju?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Alamat Pemaju</label>
                                                    <div class="col-md-10">
                                                        <textarea id="alamatPemaju" name="alamatPemaju" value="<?=$alamatPemaju?>" class="form-control" rows="5"><?=$alamatPemaju?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">No Telefon</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="telPemaju" name="telPemaju" value="<?=$telPemaju?>" class="form-control" placeholder="Telefon">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">No Fax</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="faxPemaju" name="faxPemaju" value="<?=$faxPemaju?>" class="form-control" placeholder="Fax">
                                                    </div>
                                                </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card-box">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h3 class="form-section">Edit LKP</h3>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Luas Tapak Cadangan (m²)</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="luasTapak" name="luasTapak" value="<?=$luasTapak?>" class="form-control" placeholder="(m²)">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Luas Lantai (m²)</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="luasLantai" name="luasLantai" value="<?=$luasLantai?>" class="form-control" placeholder="(m²)">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="sediaPerakuan" name="sediaPerakuan" value="<?=$sediaPerakuan?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="kepMesyuarat" name="kepMesyuarat" value="<?=$kepMesyuarat?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <h3 class="form-section">Edit PS</h3>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Pelan Struktur (No Fail)</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="pelanStruktur" name="pelanStruktur" value="<?=$pelanStruktur?>" class="form-control" placeholder="Nombor Struktur">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">No Pelan Saniteri</label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="pelanSaniteri" name="pelanSaniteri" value="<?=$pelanSaniteri?>" class="form-control" placeholder="Nombor Saniteri">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="terimaPelanStruktur" name="terimaPelanStruktur" value="<?=$terimaPelanStruktur?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="terimaPelanSaniteri" name="terimaPelanSaniteri" value="<?=$terimaPelanSaniteri?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card-box">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h3 class="form-section">Edit KPB / KMB</h3>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Kelulusan Pelan Bangunan</label>
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="kpb" name="kpb" value="<?=$kpb?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="kmb" name="kmb" value="<?=$kmb?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <h3 class="form-section">Edit Tarikh Borang</h3>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Tarikh Kemuka Borang B</label>
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="tarikhBorangB" name="tarikhBorangB" value="<?=$tarikhBorangB?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div><!-- input-group -->
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group">
                                                            <input type="date" id="tarikhBorangCCC" name="tarikhBorangCCC" value="<?=$tarikhBorangCCC?>" class="form-control" placeholder="dd/mm/yyyy" id="datepicker">
                                                            <span class="input-group-addon bg-primary b-0 text-white"><i class="ti-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="dlmPemantauan" type="text" id="dlmPemantauan" value="<?=$dlmPemantauan?>" class="form-control">
                                                            <option type="text" id="dlmPemantauan" name="dlmPemantauan" value="<?=$dlmPemantauan?>"><?=$dlmPemantauan?></option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            ...
                                                            <button type="submit" onclick="return confirm('Kemaskini berjaya.')" class="btn btn-success waves-effect waves-light">Kemaskini</button>
                                                            <button type="button" class="btn btn-default waves-effect waves-light" onclick="window.history.back();">Kembali</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
